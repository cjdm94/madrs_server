...
class TestMadrsSelfSubmission(TestCase):
    def test_add_response(self):
        ...
        self.assertEqual(submission.depression_severity(),
                         MadrsSelfSeverityCategories.MODERATE_DEPRESSION)
    ...
    def test_add_response_err_max_responses(self):
        ...
        with self.assertRaises(Exception):
            submission.add_response(stubbed_responses.get(
                MadrsSelfSymptoms.ZEST_FOR_LIFE))
    ...
    def test_add_response_err_duplicate_symptom(self):
        ...
        with self.assertRaises(Exception):
            submission.add_response(
                stubbed_responses.get(MadrsSelfSymptoms.MOOD))
