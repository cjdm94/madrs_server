...
urlpatterns = [
    ...
    path('mdrs-self/submission/response',
         views.add_madrs_self_patient_submission_response),

    # for a given patient, GET mean for each question across all their submissions
    path('patient/<int:patient_id>/madrs-self/submissions/mean-scores',
         views.patient_historical_madrs_self_mean_scores),

    # GET mean for each question across all submissions by all patients
    path('patients/madrs-self/submissions/mean-scores',
         views.patients_historical_madrs_self_mean_scores),
    ...
    path('patients/madrs-self/submissions',
         views.patients_historical_madrs_self_submissions)
]
